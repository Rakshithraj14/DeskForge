...
- open_application: args { "name": string, "url"?: string } - name or path of an application to launch. If the user wants a specific webpage opened in a browser, pass it as "url" rather than putting it in "name" - this opens it as a new tab in the browser's existing window instead of a blank new one. Built-in Windows app names "gallery"/"photos", "settings", "store", and "camera" are also accepted.
